...
public class TurnToPose extends CommandBase {
    ...
    public TurnToPose(Callisto robot, Pose2d targetPose) {
        this.robot = robot;
    ...
    public TurnToPose(Callisto robot, Pose2d targetPose, double timeout) {
        this.robot = robot;
        this.mecanum = robot.mecanum;
        this.targetPose = targetPose;
    ...
    public void initialize() {
        ...
        action = mecanum.actionBuilder(mecanum.pose).turnTo(targetPose.heading.toDouble()).build();
    }
